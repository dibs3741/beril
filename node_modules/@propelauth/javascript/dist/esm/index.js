...
function createClient(authOptions) {
  ...
  const client = {
    ...
    getAuthOptions() {
      var _authOptions$disableR, _authOptions$skipInit;
      return {
        ...
        disableRefreshOnFocus: (_authOptions$disableR = authOptions.disableRefreshOnFocus) !== null && _authOptions$disableR !== void 0 ? _authOptions$disableR : false,
        skipInitialFetch: (_authOptions$skipInit = authOptions.skipInitialFetch) !== null && _authOptions$skipInit !== void 0 ? _authOptions$skipInit : false
      };
    }
  };
